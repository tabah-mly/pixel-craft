...
class EnemyBase:
    def initialize(self, player, x, y):
        self.state = "walk"
    ...
    def apply_difficulty(self, difficulty):
        self.stats["max_hp"] = self.stats["max_hp"] * 0.5 * difficulty
        self.stats["hp"] = self.stats["hp"] * 0.5 * difficulty
        self.stats["damage"] = self.stats["damage"] * 0.5 * difficulty
        self.stats["speed"] = self.stats["speed"] * 0.5 * difficulty
        self.stats["attack_range"] = self.stats["attack_range"] * 0.5 * difficulty
